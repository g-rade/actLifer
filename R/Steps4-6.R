...
#' @export
#'
#' @examples number_to_survive(mortality2, "age_group", "population", "deaths")
...
#' @export
#'
#' @examples prop_to_survive(mortality2, "age_group", "population", "deaths")
...
#' @export
#'
#' @examples person_years(mortality2, "age_group", "population", "deaths")
